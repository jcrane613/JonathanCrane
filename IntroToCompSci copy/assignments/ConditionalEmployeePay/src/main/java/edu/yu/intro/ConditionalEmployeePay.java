...

{
  // main method begins execution of Java application
      public static void main(String[] args)
      {
        ...
        if (hrsWorked < 1) {
            System.out.println("Error: Check the amount of hours recorded");
          }
        else if (wageRate < 15 ){
            System.out.println("Error: Check the value of wages per hour ");
          }
        else if (0 >= deductions || deductions >= 35) {
            System.out.println("Error: Check the deductions value");
        }
        else {
        ...
        if (NetPay < 0) {
          System.out.println("Error: You entered a negative number for NetPay, which was " + NetPay);
          }
        else {
        System.out.println("*************************************************");
        //Input values
