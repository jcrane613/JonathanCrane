...
import edu.yu.cs.com1320.project.stage4.impl.UtilsTest;
...
public class TrieImplTest {
	...
	public void init() throws Exception {
		...
		this.pdfData4 = UtilsTest.textToPdfData(this.pdfTxt4);
		...
		this.pdfData3 = UtilsTest.textToPdfData(this.pdfTxt3);
	}
